...
class Configuration(models.Model):
    ...
    key_pairs = models.JSONField(default=default_key_pairs, null=True, blank=True, verbose_name="Key Pairs", help_text="The Key-Pairs instances need to make the first request.")
